...
<body>
    <div id="app">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <p class="card-text">
                                        Data-data mengenai provider yang akan diteliti dapat di representasikan dalam
                                        tabel berikut:
                                    </p>
                                </div>
                                <button type="button" class="btn btn-success btn-xs sm m-4" data-bs-toggle="modal"
        ...
        <div class='dropdown'>
            <button class='btn btn-info dropdown-toggle me-1 btn-sm' type='button'
